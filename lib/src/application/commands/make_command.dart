...
final class MakeCommand implements CliCommandContract {
  ...
  Future<void> handle(List<MineralCommand> _, List<String> arguments) async {
    ...
    //   CommandType.declaration => _buildDeclaration(clazz),
    //   CommandType.definition => _buildDefinition(clazz),
    // };
  }

//   Future<void> _buildDeclaration(Class clazz) async {
...
//   Future<void> _buildDeclarationClass(Class clazz) async {
